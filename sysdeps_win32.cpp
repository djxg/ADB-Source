...
//	char *tmp=(char *)src;
    ...
    if (avail > 0)
    {
        ...
        memcpy( bip->buff + bip->a_end, (char *)src, avail );
        src=(char *)src+ avail;
        count += avail;
        len   -= avail;
...
//			WriteFile( GetStdHandle( STD_OUTPUT_HANDLE ), "ssss\n", 5, NULL, NULL );
...
//	WriteFile( GetStdHandle( STD_OUTPUT_HANDLE ), "fdevent_plist_dequeue\n", sizeof("fdevent_plist_dequeue\n"), NULL, NULL );
...
#endif
        fdevent_process();
//		WriteFile( GetStdHandle( STD_OUTPUT_HANDLE ), "1111\n", 5, NULL, NULL ); 
...
//			WriteFile( GetStdHandle( STD_OUTPUT_HANDLE ), "0000\n", 5, NULL, NULL ); 
            fde->func(fde->fd, events, fde->arg);
			
        }
//		WriteFile( GetStdHandle( STD_OUTPUT_HANDLE ), "2222\n", 5, NULL, NULL );
    }
}
